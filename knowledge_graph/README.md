...
### environment setup
`conda create -n llmkg python=3.10`
...
**llm server will start at localhost:port**

more details on [api-for-open-llm guide](./api-for-open-llm/README.md)

### graph extract
put the text file in the `data_input` folder and
